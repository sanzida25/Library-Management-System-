		...
		<div class="col-md-3">
			<div class="card bg-light" style="width: 330px">
				...
				<div class="card-body">
					...
					<a href="regt_users.php" class="btn btn-warning" target="_blank">View Registered Users</a>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="card bg-light" style="width: 330px">
				...
				<div class="card-body">
					...
					<a href="regt_books.php" class="btn btn-primary" target="_blank">View Registered Books</a>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="card bg-light" style="width: 330px">
				...
				<div class="card-body">
					...
					<a href="regt_catg.php" class="btn btn-info" target="_blank">View Categories</a>
				</div>
			</div>
		</div>
		<div class="col-md-3">
			<div class="card bg-light" style="width: 330px">
				...
				<div class="card-body">
					...
					<a href="regt_auth.php" class="btn btn-secondary" target="_blank">View Authors</a>
				</div>
			</div>
		</div>
		<br>
