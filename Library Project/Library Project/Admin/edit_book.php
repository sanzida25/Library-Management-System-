...
<?php
	if(isset($_POST['update'])){
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"Library");
		$query = "update books set book_name = '$_POST[book_name]',author_name='$_POST[author_name]',cat_name='$_POST[cat_name]',book_price = '$_POST[book_price]'where book_no = $_GET[bn]";
		$query_run = mysqli_query($connection,$query);
